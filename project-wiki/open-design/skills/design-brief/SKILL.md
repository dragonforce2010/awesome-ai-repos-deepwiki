...
用于把需求整理成清晰的设计 brief、目标、范围、约束和验收标准。

## 协议快照

- 原始来源：`skills/design-brief/SKILL.md`
- Skill 名称：`design-brief`
- 触发词：`design brief`, `create a design brief`, `ilang brief`, `structured brief`
- `mode`: `design-system`
- `scenario`: `planning`
- `platform`: `desktop`
