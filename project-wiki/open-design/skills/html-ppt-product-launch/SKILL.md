...
用于生成发布会、产品更新或 go-to-market 叙事的演示文稿。

## 协议快照

- 原始来源：`skills/html-ppt-product-launch/SKILL.md`
- Skill 名称：`html-ppt-product-launch`
- 触发词：`product launch`, `keynote`, `launch deck`, `feature reveal`, `launch slides`, `发布会`
- `mode`: `deck`
- `scenario`: `marketing`
- `featured`: `21`
