...
用于生成结构化电子指南、章节页、导读和可分享的长文档页面。

## 协议快照

- 原始来源：`skills/digital-eguide/SKILL.md`
- Skill 名称：`digital-eguide`
- 触发词：`e-guide`, `digital guide`, `lead magnet`, `lookbook`, `creator guide`, `playbook`, `pdf guide`, `ebook`, `电子指南`, `电子书`
- `mode`: `prototype`
- `scenario`: `marketing`
- `platform`: `desktop`
- `featured`: `2`
