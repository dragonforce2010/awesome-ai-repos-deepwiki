...
用于系统性评审设计产物，指出层级、视觉、可用性和执行质量问题。

## 协议快照

- 原始来源：`skills/critique/SKILL.md`
- Skill 名称：`critique`
- 触发词：`critique`, `design review`, `design audit`, `5 维度评审`, `5-dim review`, `audit my design`, `review my deck`, `review my landing page`, `评审`, `复盘`
- `mode`: `prototype`
- `scenario`: `design`
- `platform`: `desktop`
