...
用于生成约会、社交匹配或情感类产品的网页原型。

## 协议快照

- 原始来源：`skills/dating-web/SKILL.md`
- Skill 名称：`dating-web`
- 触发词：`dating app`, `dating site`, `matchmaking`, `social dashboard`, `community dashboard`, `consumer dashboard`, `约会应用`, `婚恋`
- `mode`: `prototype`
- `scenario`: `personal`
- `platform`: `desktop`
- `featured`: `1`
