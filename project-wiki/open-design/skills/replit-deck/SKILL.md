...
用于生成 Replit 气质的产品、开发者工具或技术演示。

## 协议快照

- 原始来源：`skills/replit-deck/SKILL.md`
- Skill 名称：`replit-deck`
- 触发词：`replit deck`, `replit slides`, `replit 风格 ppt`, `replit style deck`, `helix deck`, `holm memo`, `atlas chapter`, `bluehouse`, `bevel campaign`
- `mode`: `deck`
- `scenario`: `product`
