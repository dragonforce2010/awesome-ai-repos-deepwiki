...
用于生成带积分、任务、进度和反馈机制的应用原型。

## 协议快照

- 原始来源：`skills/gamified-app/SKILL.md`
- Skill 名称：`gamified-app`
- 触发词：`gamified app`, `habit tracker`, `rpg app`, `level up app`, `daily quests`, `xp app`, `streak app`, `life management app`, `游戏化`, `习惯打卡`
- `mode`: `prototype`
- `scenario`: `personal`
- `platform`: `mobile`
- `featured`: `4`
