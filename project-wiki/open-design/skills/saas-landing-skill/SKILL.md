...
用于生成单页 SaaS 落地页，覆盖 hero、功能、社会证明、定价和 CTA，并遵循活动 DESIGN.md。

## 协议快照

- 原始来源：`docs/examples/saas-landing-skill/SKILL.md`
- Skill 名称：`saas-landing`
- 触发词：`saas landing`, `marketing page`, `product landing`
- `mode`: `prototype`
