...
用于生成项目周报、进展复盘和指标同步演示文稿。

## 协议快照

- 原始来源：`skills/html-ppt-weekly-report/SKILL.md`
- Skill 名称：`html-ppt-weekly-report`
- 触发词：`weekly report`, `周报`, `status update`, `team report`, `business review`, `wbr`
- `mode`: `deck`
- `scenario`: `operations`
- `featured`: `23`
