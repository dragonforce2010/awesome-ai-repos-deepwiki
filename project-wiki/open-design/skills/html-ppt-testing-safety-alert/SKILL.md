...
用于生成测试、安全风险、告警或治理主题的演示文稿。

## 协议快照

- 原始来源：`skills/html-ppt-testing-safety-alert/SKILL.md`
- Skill 名称：`html-ppt-testing-safety-alert`
- 触发词：`safety alert`, `incident`, `red team`, `risk review`, `事故复盘`, `安全评审`, `policy as code`
- `mode`: `deck`
- `scenario`: `engineering`
- `featured`: `32`
