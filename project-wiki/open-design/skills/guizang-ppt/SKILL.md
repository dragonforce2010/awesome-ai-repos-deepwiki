...
用于生成中文电子杂志/电子墨水气质的横向翻页网页 PPT。

## 协议快照

- 原始来源：`skills/guizang-ppt/SKILL.md`
- Skill 名称：`magazine-web-ppt`
- 触发词：`ppt`, `deck`, `slides`, `presentation`, `magazine`, `杂志`, `杂志风 PPT`, `horizontal swipe`, `horizontal swipe deck`, `editorial magazine`, `e-ink presentation`, `网页 PPT`, `发布会`, `分享 PPT`
- `mode`: `deck`
- `scenario`: `marketing`
- `featured`: `9`
