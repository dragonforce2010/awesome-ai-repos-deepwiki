...
用于生成工程技术分享、架构讲解或方案汇报演示文稿。

## 协议快照

- 原始来源：`skills/html-ppt-tech-sharing/SKILL.md`
- Skill 名称：`html-ppt-tech-sharing`
- 触发词：`tech sharing`, `tech talk`, `技术分享`, `engineering talk`, `conference talk`, `dev talk`
- `mode`: `deck`
- `scenario`: `engineering`
- `featured`: `22`
