...
用于生成课程章节、知识点、练习和教学节奏明确的网页 PPT。

## 协议快照

- 原始来源：`skills/html-ppt-course-module/SKILL.md`
- Skill 名称：`html-ppt-course-module`
- 触发词：`course module`, `course slides`, `workshop`, `training deck`, `lesson`, `教学`, `课件`
- `mode`: `deck`
- `scenario`: `education`
- `featured`: `25`
