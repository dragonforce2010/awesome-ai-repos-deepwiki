...
description: 发布后文档同步技能，更新 README、ARCHITECTURE、CHANGELOG 等。
---

# document-release 中文审阅副本

> 来源：`document-release/SKILL.md`  
> 生成说明：本副本面向中文审阅，保留 `name`、命令、路径、代码块和原始行为要求。原始 `SKILL.md` 完整收录在下方折叠块中，便于逐条比对可执行指令。

## 中文概要

发布后文档同步技能，更新 README、ARCHITECTURE、CHANGELOG 等。
