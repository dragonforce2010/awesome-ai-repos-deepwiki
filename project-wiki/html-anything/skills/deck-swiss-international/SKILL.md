...
description: 使用【瑞士国际主义 Deck】设计规范生成网页。风格为: 16 列网格 + 单一饱和 accent + 22 个锁死版面 (Klein Blue / Lemon / Mint / Safety Orange)。类别: slides。场景: marketing。规格: 16:9 横向翻页。适用于零配置、快速流式生成高水准排版的网页 HTML 代码。
---
