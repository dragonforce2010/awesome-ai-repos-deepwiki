...
description: 使用【品牌 Logo 收尾帧】设计规范生成网页。风格为: Logo 分块组装入场 + glow bloom + tagline 揭示, 适合视频片尾 / 品牌闭幕。类别: video。场景: video。规格: 1920×1080 (16:9)。适用于零配置、快速流式生成高水准排版的网页 HTML 代码。
---
